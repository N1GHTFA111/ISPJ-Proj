...
file_path = r'D:\PROJECTS\SCHOOL\Yr2_sem2\IT2566_ispj\ISPJ_PROJ\Sentinel_api\SentinelSuite\xss-payload-list-master\xss-payload-list-master\Intruder\xss-payload-list.txt'
...
vectorizer = TfidfVectorizer(ngram_range=(1, 3), min_df=5, max_features=1000, sublinear_tf=True)
